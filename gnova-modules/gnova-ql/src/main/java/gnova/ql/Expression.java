...
import gnova.ql.util.ExpressionInstancer;
import gnova.ql.parse.ExpressionParser;
import gnova.ql.parse.ParseException;
import gnova.ql.util.ExpressionSimplifier;
 ...
 * <p>表达式的构建：
 * <br>使用{@link ExpressionFactory 表达式工厂类}构建不同类型的表达式，不推荐使用表达式的构造器，因为在工厂类的构建器中，
