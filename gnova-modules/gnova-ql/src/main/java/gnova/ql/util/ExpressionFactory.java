...
import gnova.ql.DateExpressionImpl;
...
import gnova.ql.MultipleExpression;
import gnova.ql.MultipleExpressionImpl;
import gnova.ql.NegativeExpression;
import gnova.ql.NegativeExpressionImpl;
import gnova.ql.NullExpression;
import gnova.ql.NumberExpression;
import gnova.ql.PlaceholderExpression;
import gnova.ql.PredicateExpression;
import gnova.ql.SimpleExpression;
import gnova.ql.SimpleExpressionImpl;
import gnova.ql.StringExpression;
import gnova.ql.StringExpressionImpl;
import gnova.ql.TimestampExpression;
import gnova.ql.TimestampExpressionImpl;
...
public class ExpressionFactory {
    ...
    public static Int32Expression buildInt32(int val) {
        return new Int32ExpressionImpl(val);
    }
    ...
    public static Int64Expression buildInt64(long val) {
        return new Int64ExpressionImpl(val);
    }
    ...
    public static DoubleExpression buildDouble(double val) {
        return new DoubleExpressionImpl(val);
    }
    ...
    public static StringExpression buildString(@NotNull String val) {
        return new StringExpressionImpl(val);
    }
    ...
    public static BytesExpression buildBytes(@NotNull byte[] val) {
        ...
        return new BytesExpressionImpl(val);
    }

    public static DateExpression buildNowDate() {
        return new DateExpressionImpl(new Date());
    }

    public static DateExpression buildDate(@NotNull Date date) {
        return new DateExpressionImpl(date);
    }
    ...
    public static DateExpression buildDate(@NotNull String date, String format)
            throws UnsupportedOperationException, IllegalArgumentException {
        return new DateExpressionImpl(date, format);
    }

    public static TimestampExpression buildNowTimestamp() {
        return new TimestampExpressionImpl(System.currentTimeMillis());
    }

    public static TimestampExpression buildTimestamp(long timeMillis) {
        return new TimestampExpressionImpl(timeMillis);
    }
    ...
    public static GeometryExpression buildGeometry(@NotNull Geometry val)
        ...
        return new GeometryExpressionImpl(val);
    }
    ...
    public static ListExpression buildList(@NotNull ValueExpression... values) {
        ...
        return new ListExpressionImpl(values);
    }
    ...
    public static KeyExpression buildKey(@NotNull String keyName) {
        ...
        return new KeyExpressionImpl(keyName);
    }
