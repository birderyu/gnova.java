 ...
 * <br>{@link BooleanExpression 布尔值表达式}，表示一个布尔值；
 * <br>{@link NumberExpression 数字值表达式}，表示一个数字值；
 * <br>{@link StringExpression 字符串值表达式}，表示一个字符串值；
 * <br>{@link GeometryExpression 几何区域值表达式}，表示一个几何区域值；
 *
 * @see NullExpression
