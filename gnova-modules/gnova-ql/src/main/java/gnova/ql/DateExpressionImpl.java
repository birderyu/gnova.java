...
public final class DateExpressionImpl
    ...
    protected boolean equalsBy(@NotNull Object left) {
        ...
        } else if (left instanceof DateExpressionImpl) {
            return ((DateExpressionImpl) left).value.isEqual(value);
        }
        return false;
    }
    ...
    protected boolean lessBy(@NotNull Object left) {
        if (left instanceof Date) {
            ...
            return ((DateExpressionImpl) left).value.isBefore(value);
        }
        return false;
    }
    ...
    protected boolean lessEqualsBy(@NotNull Object left) {
        if (left instanceof Date) {
            ...
            DateTime leftValue = ((DateExpressionImpl) left).value;
            return leftValue.isBefore(value) || leftValue.isEqual(value);
        }
        return false;
    }
    ...
    protected boolean greaterBy(@NotNull Object left) {
        if (left instanceof Date) {
            ...
            return ((DateExpressionImpl) left).value.isAfter(value);
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            return true;
        } else if (!(obj instanceof DateExpressionImpl)) {
            return false;
        }
        DateExpressionImpl de = (DateExpressionImpl) obj;
